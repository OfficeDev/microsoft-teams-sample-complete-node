...
export const DialogMatches = {
    ...
    O365ConnectorCardActionsDialog1Match: /connector card actions 1?/i,
    O365ConnectorCardActionsDialog2Match: /connector card actions 2?/i,
    O365ConnectorCardActionsDialog3Match: /connector card actions 3?/i,
