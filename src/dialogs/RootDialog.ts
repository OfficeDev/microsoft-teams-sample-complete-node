...
import { O365ConnectorCardActionsDialogV1 } from "./examples/basic/O365ConnectorCardActionsDialogV1";
import { O365ConnectorCardActionsDialogV2 } from "./examples/basic/O365ConnectorCardActionsDialogV2";
import { O365ConnectorCardActionsDialogV3 } from "./examples/basic/O365ConnectorCardActionsDialogV3";
...
export class RootDialog extends builder.IntentDialog {
    ...
    public createChildDialogs(): void {
        ...
        new O365ConnectorCardActionsDialogV1(bot);
        new O365ConnectorCardActionsDialogV2(bot);
        new O365ConnectorCardActionsDialogV3(bot);
