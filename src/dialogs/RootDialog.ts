...
import { O365ConnectorCardActionsDialog1 } from "./examples/basic/O365ConnectorCardActionsDialog1";
import { O365ConnectorCardActionsDialog2 } from "./examples/basic/O365ConnectorCardActionsDialog2";
import { O365ConnectorCardActionsDialog3 } from "./examples/basic/O365ConnectorCardActionsDialog3";
...
export class RootDialog extends builder.IntentDialog {
    ...
    public createChildDialogs(): void {
        ...
        new O365ConnectorCardActionsDialog1(bot);
        new O365ConnectorCardActionsDialog2(bot);
        new O365ConnectorCardActionsDialog3(bot);
